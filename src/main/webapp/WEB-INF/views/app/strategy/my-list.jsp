                    ...
                    <table class="table border-bottom">
                        ...
                        <c:forEach var="strategy" items="${strategies}" varStatus="stat">
                            <tr class="d-flex">
                                ...
                                <td class="col-2"><c:out value="${strategy.percentMoney}"/></td>
                                ...
                                <td class="col-2 d-flex align-items-center justify-content-center flex-wrap">
                                    <sec:authorize access="hasRole('ADMIN')">
                                        <a href="/app/strategy/my-list-delete?strategyId=${strategy.getId()}"
                                           class="btn btn-danger rounded-0 text-light m-1">Usuń</a>
                                        <a href="/app/strategy/my-list-edit?strategyId=${strategy.getId()}"
